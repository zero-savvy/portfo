            ...
            <div className="about-container">
                <div className="row">
                    ...
                    <div className="about-content">
                        ...
                        Zero-Savvy, established in 2023 (Registered in 2025 in UK), is a non-profit community-driven organization that is a team of applied cryptography researchers on a mission to eliminate trust barriers in daily digital routines. Join our community, contribute, and collaborate to shape a future where everyone enjoys a hassle-free, secure, and private cyber experience! 🌐🔒🛡️
                        </p>
                        <p className="contact">
